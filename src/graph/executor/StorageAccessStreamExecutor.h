...
#ifndef GRAPH_EXECUTOR_STORAGEACCESSSTREAMEXECUTOR_H_
#define GRAPH_EXECUTOR_STORAGEACCESSSTREAMEXECUTOR_H_
...
class StorageAccessStreamExecutor : public StreamExecutor {
 protected:
  StorageAccessStreamExecutor(const std::string &name, const PlanNode *node, QueryContext *qctx)
      : StreamExecutor(name, node, qctx) {}
...
#endif  // GRAPH_EXECUTOR_STORAGEACCESSSTREAMEXECUTOR_H_

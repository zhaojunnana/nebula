...
#ifndef _EXEC_QUERY_GET_PROP_STREAMEXECUTOR_H_
#define _EXEC_QUERY_GET_PROP_STREAMEXECUTOR_H_
...
class GetPropStreamExecutor : public StorageAccessStreamExecutor {
 protected:
  GetPropStreamExecutor(const std::string &name, const PlanNode *node, QueryContext *qctx)
      : StorageAccessStreamExecutor(name, node, qctx) {}

  template <typename Response>
  StatusOr<std::shared_ptr<RoundResult>> handleResp(storage::StorageRpcResponse<Response> &&rpcResp,
...
#endif  // _EXEC_QUERY_GET_PROP_STREAMEXECUTOR_H_
